  ...
  <section class="my-4 quick-cat-section text-center" data-aos="zoom-up" data-aos-delay="100">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100" itemscope itemtype="https://schema.org/Review">
                <div class="h-100 bg-white p-4 rounded-0 shadow-sm border d-flex flex-column justify-content-between" style="border-color: #e0f2fe !important;">
                    <div>
                        ...
                        <p class="text-secondary mb-4 small" style="line-height: 1.6; font-style: italic;" itemprop="reviewBody">
                    ...
                    <div class="d-flex align-items-center gap-3 pt-3 border-top border-light">
                        <div class="fw-bold rounded-0-circle d-flex align-items-center justify-content-center" style="width: 45px; height: 45px; min-width: 45px; font-size: 0.95rem; background-color: #e0f2fe; color: #0369a1;" itemprop="author" itemscope itemtype="https://schema.org/Person">
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200" itemscope itemtype="https://schema.org/Review">
                <div class="h-100 bg-white p-4 rounded-0 shadow-sm border d-flex flex-column justify-content-between" style="border-color: #fce7f3 !important;">
                    ...
                    <div class="d-flex align-items-center gap-3 pt-3 border-top border-light">
                        <div class="fw-bold rounded-0-circle d-flex align-items-center justify-content-center" style="width: 45px; height: 45px; min-width: 45px; font-size: 0.95rem; background-color: #fce7f3; color: #b5179e;" itemprop="author" itemscope itemtype="https://schema.org/Person">
    ...
    <section id="faq" class="faq-section my-5 py-4" data-aos="fade-up" data-aos-duration="800">
        <div class="container-fluid px-3 px-md-5">
            ...
            <div class="row g-4" itemscope itemtype="https://schema.org/FAQPage">
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="150" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <div class="p-4 h-100 rounded-0 bg-white shadow-sm faq-modern-card faq-blue border d-flex flex-column">
                        <div class="d-flex align-items-center gap-3 mb-3">
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="250" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                    <div class="p-4 h-100 rounded-0 bg-white shadow-sm faq-modern-card faq-pink border d-flex flex-column">
                        <div class="d-flex align-items-center gap-3 mb-3">
